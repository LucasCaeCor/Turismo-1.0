        ...
        function iniciarMonitoramento() {
            if (navigator.geolocation) {
                ...
                navigator.geolocation.watchPosition(function(position) {
                    ...
                    alert(mensagemErro);
                    // Oferece uma alternativa para inserção manual
    ...
    <div class="container mt-5">
        ...
        <?php else: ?>
            <div class="alert alert-warning mt-4 text-center">
                <strong>Apenas usuários não Administradores e Cadastrados podem solicitar o cadastro de pontos turísticos.</strong>
            </div>
        <?php endif; ?>
    </div>
